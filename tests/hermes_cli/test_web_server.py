...
def test_resolve_chat_argv_does_not_attach_gateway_by_default(monkeypatch):
    ...
    monkeypatch.delenv("HERMES_DASHBOARD_CHAT_ATTACH_GATEWAY", raising=False)
...
def test_resolve_chat_argv_injects_gateway_ws_url_when_opted_in(monkeypatch):
    import hermes_cli.main as cli_main
    import hermes_cli.web_server as ws
    ...
    monkeypatch.setattr(ws.app.state, "bound_host", "127.0.0.1", raising=False)
    monkeypatch.setattr(ws.app.state, "bound_port", 9119, raising=False)
    monkeypatch.setenv("HERMES_DASHBOARD_CHAT_ATTACH_GATEWAY", "1")
